...
namespace juni\markdowneditor;

use Acoustep\CraftEasyMDE\Fields\CraftEasyMDEField;
use craft\events\RegisterComponentTypesEvent;
use craft\services\Fields;
use craft\web\twig\variables\CraftVariable;
use juni\markdowneditor\fields\MarkdownEditorField;
use juni\markdowneditor\plugin\Services;
use juni\markdowneditor\twigextensions\MarkdownEditorTwigExtension;
...
class MarkdownEditor extends Plugin
{
    ...
    public function init()
    {
        ...
        Craft::$app->view->registerTwigExtension(new MarkdownEditorTwigExtension());
        ...
        Event::on(
            ...
            function (RegisterComponentTypesEvent $event) {
                $event->types[] = MarkdownEditorField::class;
            }
        );
